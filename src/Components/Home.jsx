...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      <h1 class="title-font font-medium text-3xl text-gray-900">Document Upload Portal</h1>
      <p class="leading-relaxed mt-4">The Document Portal is where you upload documents that need to be signed, determine who should approve them before being sent to any signer(s), determine who should sign them, which signing method they may choose from, and then send the documents via secured email.</p>
    </div>
    <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <p class="text-xs text-gray-500 mt-3">Here you are ready to upload your documents</p>
    </div>
  </div>
</section>
